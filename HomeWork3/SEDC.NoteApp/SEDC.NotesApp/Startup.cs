...
namespace SEDC.NotesApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //get value for AppSettings propery in appsettings.json
            var appSettingsConfiguration = Configuration.GetSection("AppSettings");
            services.Configure<AppSettings>(appSettingsConfiguration); //mapped to Object with type AppSettings

            AppSettings appSettings = appSettingsConfiguration.Get<AppSettings>(); //instance object 
